                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('nilai.update', $nilai->id) }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select name="mahasiswa_id" class="form-control">
                                    ...
                                    @foreach ($mahasiswa as $mhs)
                                        <option value="{{ $mhs->id }}"
                                            {{ $mhs->id == $nilai->mahasiswa_id ? 'selected' : '' }}>{{ $mhs->nama }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="matkul_id" class="form-control">
                                    ...
                                    @foreach ($matkul as $mk)
                                        <option value="{{ $mk->id }}"
                                            {{ $mk->id == $nilai->matkul_id ? 'selected' : '' }}>{{ $mk->nama_matkul }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                <label>Nilai</label>
                                <input value="{{ $nilai->nilai }}" type="number" name="nilai" class="form-control"
